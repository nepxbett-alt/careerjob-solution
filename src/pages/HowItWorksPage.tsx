      ...
      {steps.map((s, i) => (
        ...
        >
          ...
          <div>
            ...
            <div className="text-sm text-[#6B7789] mt-0.5 leading-relaxed">{s.d}</div>
          </div>
        </li>
      ))}
    </ol>
  ...
  return (
    <div className="min-h-[70vh] bg-[#F7F9FC]">
      <Seo
        ...
        description="How CareerJob connects job seekers and businesses in Pokhara."
      />
      <div className="cj-container max-w-3xl py-10 md:py-14">
        ...
        <p className="text-[#3D4A5C] mb-10 leading-relaxed max-w-xl">
          CareerJob Solution is a recruitment agency platform. We connect job seekers with opportunities and help
          businesses hire — we stay involved at every step.
        </p>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-bold text-[#0B1220] mb-4">For businesses</h2>
          <StepList steps={BUSINESS} tone="ink" />
